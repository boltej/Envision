...
public:
	...
	std::string m_id;
	float m_trust=0;
	float m_signalStrength=0;
	float m_influence=0;

	SNNode* m_pFromNode = nullptr;
	SNNode* m_pToNode = nullptr;
};
