...
enum DISTURB
   ...
   /*
   PRESCRIBED_FIRE = 27,
   PRESCRIBED_FIRE_UNDERBURNING = 28,
   ...
   */
   ...
   PRESCRIBED_FIRE = 30,
   PRESCRIBED_FIRE_UNDERBURNING = 31,
   PRESCRIBED_SURFACE_FIRE = 32,
   PRESCRIBED_LOW_SEVERITY_FIRE = 33,
   PRESCRIBED_HIGH_SEVERITY_FIRE = 34,
   PRESCRIBED_STAND_REPLACING_FIRE = 35,

   PRESCRIBED_FIRE_2 = 40,
   PRESCRIBED_FIRE_UNDERBURNING_2 = 41,
   PRESCRIBED_SURFACE_FIRE_2 = 42,
   PRESCRIBED_LOW_SEVERITY_FIRE_2 = 43,
   PRESCRIBED_HIGH_SEVERITY_FIRE_2 = 44,
   PRESCRIBED_STAND_REPLACING_FIRE_2 = 45,

   THINNING = 2,
   PARTIAL_HARVEST = 3,
   RESTORATION_ACTIVITY = 4,
   PLANTATION = 5,
   SELECTION_HARVEST = 6,


   // forest restoration management
   MECHANICAL_TREATMENT = 50,
   MECHANICAL_THINNING = 51,
   MOWING_GRINDING = 52,
   SALVAGE_HARVEST = 53,
   SUPRESSION = 54,
   EVEN_AGED_TREATMENT = 55,
   THIN_FROM_BELOW = 56,
   PARTIAL_HARVEST_LIGHT = 57,
   PARTIAL_HARVEST_HIGH = 58,

   MECHANICAL_TREATMENT_2 = 60,
   MECHANICAL_THINNING_2 = 61,
   MOWING_GRINDING_2 = 62,
   SALVAGE_HARVEST_2 = 63,
   SUPRESSION_2 = 64,
   EVEN_AGED_TREATMENT_2 = 65,
   THIN_FROM_BELOW_2 = 66,
   PARTIAL_HARVEST_LIGHT_2 = 67,
   PARTIAL_HARVEST_HIGH_2 = 68,
...
enum CONSERVE
   ...
   CONSERVATION = 5,
   RESTORATION = 6,
   HABITAT_CONSERVATION =7,
   HABITAT_RESTORATION = 8,
   WATER_CONSERVATION=9,
   WATER_RESTORATION=10
   };