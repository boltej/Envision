...
enum DISTURB
   ...
   */
   ...
   MECHANICAL_TREATMENT = 58,  // was 60

   MECHANICAL_THINNING_2 = 60,
   MOWING_GRINDING_2 = 61,
   SALVAGE_HARVEST_2 = 62,
   SUPRESSION_2 = 63,
   EVEN_AGED_TREATMENT_2 = 64,
   THIN_FROM_BELOW_2 = 65,
   PARTIAL_HARVEST_LIGHT_2 = 66,
   PARTIAL_HARVEST_HIGH_2 = 67,
   MECHANICAL_TREATMENT_2 = 68,
