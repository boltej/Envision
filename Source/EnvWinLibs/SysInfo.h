...
public:
   ...
   /*
	...
	LPCTSTR GetMIBAdapterDescr(int i);
	...
	LPCTSTR GetAPIAdapterMaskStr(int i,int indexIP);
	LPCTSTR GetAPIAdapterIPStr(int i, int indexIP);
	int GetAPINumAddresses(int i);
	LPCTSTR GetAPIAdapterName(int i);
	LPCTSTR GetAPIAdapterDescr(int i);
