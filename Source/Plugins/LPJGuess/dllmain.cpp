...
// Models
extern "C" float PASCAL EXPORT Init_Guess(FlowContext *pFlowContext, LPCTSTR);
...
float PASCAL Init_Guess(FlowContext *pFlowContext,  LPCTSTR initStr) { return theModel->Init_Guess(pFlowContext, initStr); }
