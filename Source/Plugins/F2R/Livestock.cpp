...
LivestockModel::LivestockModel( void )
: m_id( NITROGEN )   
, m_colLulc( -1 )
, m_colArea( -1 )
, m_colDairyAvg( -1 )
...
bool LivestockModel::Init( EnvContext *pEnvContext, LPCTSTR initStr )
   {
   // load table
...
bool LivestockModel::InitRun( EnvContext *pContext )
   {
...
bool LivestockModel::Run( EnvContext *pContext, bool useAddDelta )
   {
...
void LivestockModel::AllocateLivestock( EnvContext *pContext, bool useAddDelta )
   {
...
bool LivestockModel::LoadXml( EnvContext *pContext, LPCTSTR filename )
   {
