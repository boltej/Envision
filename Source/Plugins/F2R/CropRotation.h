...
protected:
   ...
   PtrArray< Cadastre > m_cadastreArray;
   CMap< int, int, Cadastre*, Cadastre* > m_cadMap;  // key=cadID, value=ptr to the Cadastre object in m_cadastreArray
};
