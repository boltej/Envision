...
protected:
   ...
   int m_colR1mmMay;   // Number of Days in May with more than 1mm precip
   int m_colR1mmJune;   // Number of Days in June with more than 1mm precip
   ...
   static void GetR1mmMay( int startCol, int colIncrement, FDataObj *pDataOut, FDataObj *pDataIn );
   static void GetR1mmJune( int startCol, int colIncrement, FDataObj *pDataOut, FDataObj *pDataIn );
