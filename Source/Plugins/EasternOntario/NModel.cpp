...
bool NModel::Init( EnvContext *pEnvContext, LPCTSTR initStr )
   {
   theModel->m_outVarCountNModel = N_COUNT;
   theModel->m_outVarIndexNModel = theModel->AddOutputVar( "Crop N Requirement (Gg)", m_outVarArray[ N_CROP_REC ], "" );
   theModel->AddOutputVar( "N Fixed (Gg)",               m_outVarArray[ N_FIXED], "" );
   theModel->AddOutputVar( "N Deposition (Gg)",          m_outVarArray[ N_DEPOSIT ], "" );
   theModel->AddOutputVar( "N Removed with Crops (Gg)",  m_outVarArray[ N_CROP_REM ], "" );
   theModel->AddOutputVar( "Total Manure N (Gg)",        m_outVarArray[ N_MANURE_TOT ], "" );
   theModel->AddOutputVar( "Fertilizer N Reqd (Gg)",     m_outVarArray[ N_FERT ], "" );
   theModel->AddOutputVar( "Net N (Gg)",                 m_outVarArray[ N_NET ], "" );
