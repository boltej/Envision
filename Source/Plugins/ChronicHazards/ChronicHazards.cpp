...
bool ChronicHazards::InitDuneModel(EnvContext* pEnvContext)
   ...
   CheckCol(m_pOrigDuneLineLayer, m_colDLNorthingToe, "NORTHING", TYPE_DOUBLE, CC_MUST_EXIST);
   CheckCol(m_pOrigDuneLineLayer, m_colDLEastingToe, "EASTING", TYPE_DOUBLE, CC_MUST_EXIST);
   ...
   CheckCol(m_pOrigDuneLineLayer, m_colDLShorelineChange, "SCRate", TYPE_FLOAT, CC_MUST_EXIST);
