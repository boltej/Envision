...
class FlamMapAP : public EnvModelProcess
   ...
   protected:
      Map* m_pMap = nullptr;
      FAGrid* m_ptLayer = nullptr;
      PolyGridLookups* m_pPolyGridLkUp = nullptr;          // store Poly-Grid lookup info for mapping grids to IDUs
      // LCPGenerator       m_lcpGenerator;
      LCPGenerator* m_pLcpGenerator = nullptr;
      FlameLengthUpdater m_flameLengthUpdater;
      EnvContext* m_pEnvContext = nullptr;
      FireYearRunner* m_pFireYearRunner = nullptr;
   ...
   protected:
      ...
      MapLayer* m_pPolyMapLayer = nullptr;
   ...
   public:
      ...
      vector<Fire> m_staticFires;
      //Fire *m_staticFires=nullptr;
