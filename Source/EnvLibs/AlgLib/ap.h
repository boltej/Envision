...
but WITHOUT ANY WARRANTY; without even the implied warranty offfp_eq
...
#include <string.h>
#ifndef NO_MFC
  //conflicts with pthread std include under clang on Linux
  //May be ok with gcc/g++
#include <setjmp.h>
#endif
#include <math.h>
#include <stddef.h>
...
LIBSAPI bool fp_eq(double v1, double v2);
LIBSAPI bool fp_neq(double v1, double v2);
LIBSAPI bool fp_less(double v1, double v2);
LIBSAPI bool fp_less_eq(double v1, double v2);
LIBSAPI bool fp_greater(double v1, double v2);
LIBSAPI bool fp_greater_eq(double v1, double v2);

LIBSAPI bool fp_isnan(double x);
LIBSAPI bool fp_isposinf(double x);
LIBSAPI bool fp_isneginf(double x);
LIBSAPI bool fp_isinf(double x);
LIBSAPI bool fp_isfinite(double x);
