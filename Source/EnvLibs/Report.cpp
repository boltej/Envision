...
int Report::PopupMsg(LPCTSTR _msg, REPORT_TYPE type, LPCTSTR hdr /*= "\0"*/, int flags /*= MB_OK */)
   {
   std::string msg;
...
int Report::BalloonMsg( LPCTSTR msg, REPORT_TYPE type, int duration /*=2000*/ )
   {
   int retVal = 0;
